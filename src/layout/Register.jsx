...
const Register = () => {
  ...
  return (
    <div className="flex items-center w-full mx-auto bg-blue-500 h-screen diagonal-background">
      <form
        onSubmit={handleSubmit}
        className="grid place-items-center lg:w-4/12 sm:w-9/12 w-11/12 mx-auto bg-white text-[#4f7cff] 
      ...
      >
        ...
        <div className="mx-auto flex justify-center items-center pt-6 pb-16">
          <button
            type="submit"
            className="bg-[#3d5fc4] text-white rounded-md text-base uppercase w-32 py-2"
          >
            Register
          </button>
        </div>
