...
const Home = () => {
  const [userId, setUserId] = useState(""); // Assuming you manage user state elsewhere
  ...
  return (
    <div className="flex flex-col items-center w-full mx-auto min-h-screen bg-blue-500 overflow-x-hidden">
      <div className="flex justify-between items-center w-full px-6 h-20 bg-[#00000012]">
        ...
        <div className="flex justify-center items-center gap-2">
          {!userId ? (
            <a
              href="/login"
              className="bg-white px-4 py-2 uppercase rounded-lg text-xl text-[#4f7cff] font-semibold"
            >
              Login
            </a>
          ) : (
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="bg-white px-4 py-2 rounded-lg text-base uppercase font-semibold text-[#4f7cff]"
              >
                Logout
              </button>
            </div>
        ...
        {data.map((item) => (
          ...
          >
            ...
            <p className="lg:text-sm text-xs text-center px-6 text-slate-500">
              ...
              quaerat dolore sit eum quas non mollitia reprehenderit repudiandae
              debitis tenetur?
            </p>
